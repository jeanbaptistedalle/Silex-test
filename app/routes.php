...
// Character detail
$app->get('/character/{id}', "Test\Controller\CharacterController::characterAction")->bind('character');
// Admin zone
$app->get('/admin', "Test\Controller\AdminController::indexAction")->bind('admin');
// Character create/update form (for Ajax call)
$app->post('/character/form/', "Test\Controller\CharacterController::prepareCharacterFormAjax")->bind('prepare_character_form_ajax');
// Character create/update form (for Ajax call)
$app->post('/character/form/response', "Test\Controller\CharacterController::characterFormAjax")->bind('character_form_ajax');
